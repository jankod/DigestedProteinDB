...
public class SearchAjaxServlet  {
    ...
    private void searchByAjax() {
        UniprotLevelDbFinder finder = null;
        float massFrom;
        float massTo;
        try {
            massFrom = Float.parseFloat(getParameter("massFrom"));
            massTo = Float.parseFloat(getParameter("massTo"));
    ...
    private String getParameter(String massFrom) {
        return null;
    }


    private synchronized void searchByServerSideProcessing() throws IOException {
        ArrayList<Row> result = new ArrayList<>();
